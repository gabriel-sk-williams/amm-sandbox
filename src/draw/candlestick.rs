...
// Example code:
// https://github.com/plotters-rs/plotters/blob/master/plotters/examples/stock.rs

// TODO: integrate as desired

const OUT_FILE_NAME: &str = "plotters-docs/stock.png";

fn parse_time(t: &str) -> DateTime<Local> {

    let datetime_str = format!("{} 0:0", t);
...
pub fn chart() -> Result<(), Box<dyn std::error::Error>> {
    let data = get_data();
    ...
    root.present().expect("Unable to write result to file, please make sure 'plotters-docs' dir exists under current dir");
